...
Replaces UTM tracking parameters with hilariously implausible alternatives. Carrier pigeons, ouija boards, and ancient prophecies.
...
Traffic appears to originate from ouija_board, ancient_prophecy, and accidental_butt_dial.
...
Privacy advocates, UTM skeptics, developers who want to keep their personal browsing out of marketing dashboards, and anyone who thinks "utm_source=fever_dream" is a reasonable attribution channel.

---

## Category
Privacy & Security  (or: Fun)
...
- [ ] Privacy policy URL: host `privacy-policy.html` and paste URL into the "Privacy policy" field
- [ ] Screenshots: capture 2–3 at 1280×800 showing the popup and a URL bar with randomized UTM params
- [ ] Promotional tile (optional): 440×280 PNG
- [ ] Small promo tile (optional): 920×680 PNG
- [ ] Developer contact email required by the store
